				...
				<div
					...
					<div class="card col-10 col-md-5 pt-5">
						<div class="row w-25 mx-auto">
							<img src="img/money-bill-alt-regular.svg" class="card-img-top"
								alt="...">
						</div>
						<div class="card-body">
							<h5 class="card-title h3">Crypto currencies</h5>
					...
					<div class="card col-10 col-md-5 mt-3 mt-md-0 pt-5">
						<div class="row w-25 mx-auto">
							<img src="img/wallet-solid.svg" class="card-img-top" alt="...">
						</div>
						<div class="card-body">
							<h5 class="card-title h3">My Wallets</h5>
							<p class="card-text">Lorem ipsum dolor sit amet, consectetur
								adipiscing elit. Maecenas non ante non urna molestie facilisis.
								Morbi nibh odio, viverra eget imperdiet eu, aliquam in nulla.
								Morbi velit erat, euismod a erat lacinia, aliquet laoreet leo.</p>
